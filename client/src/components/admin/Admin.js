                    ...
                    {this.state.users.map((user, index) => {
                        if (
                            ...
                            return (
                                <Table.Row key={index}>
                                    <Table.Cell>
                                        <Image src={user.photo_user} avatar />{' '}
                                        {user.username}
                                    </Table.Cell>
                                    <Table.Cell>
                                        {user.name.firstname}{' '}
