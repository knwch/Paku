        ...
        return (
          <Card.Content>
            ...
            <div className="text-center mt-1">
              <Button onClick={this.handleOpenForm} basic circular size="tiny">
              ...
              <Form.Field>
                <Input fluid iconPosition="left" placeholder={this.state.phone}>
                  ...
                  <input
                    maxlength="10"
                    type="text"
                    onChange={this.handleChange("tempphone")}
                    defaultValue={this.state.tempphone}
                  />
                </Input>
                {this.validator.message(
                  "เบอร์โทรศัพท์",
                  this.state.tempphone,
                  "required|phone"
                )}
              </Form.Field>
              <Form.Field>
