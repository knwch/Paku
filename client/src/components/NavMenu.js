  ...
  render() {
    ...
    const guestLinks = (
      <Nav className="nav-mobile ml-auto nowrap text-left">
        <Nav.Link className="nav-color mr-3" href="/owner">
          ให้เช่าที่จอดรถ
        </Nav.Link>
        <Nav.Link className="nav-color mr-3" href="/rent">
          จองที่จอดรถ
        </Nav.Link>
        <Nav.Link className="nav-color mr-3" href="/support">
          ช่วยเหลือ
        </Nav.Link>
        <Nav.Link className="nav-color mr-3" href="/register">
          ลงทะเบียน
        </Nav.Link>
        <Nav.Link className="nav-color" href="/login">
          เข้าสู่ระบบ
        </Nav.Link>
      </Nav>
    );
    const authLinks = (
      <Nav className="ml-auto nowrap text-left">
        <Nav.Link className="nav-color mr-3" href="/post">
          เพิ่มที่จอดรถ
        </Nav.Link>
        <Nav.Link className="nav-color mr-3" href="/rent">
          จองที่จอดรถ
        </Nav.Link>
        <Nav.Link className="nav-color mr-3" href="/mypost">
          รายการของฉัน
        </Nav.Link>
        <Nav.Link className="nav-color mr-3" href="/support">
          ช่วยเหลือ
        ...
        <NavDropdown
          alignRight
          title={<Icon name="user" color="black" />}
